...
export const Promo = () => {
    ...
    return (
        <section className={Styles["promo"]}>
            ...
            <button onClick={handleButtonClick} className={`button ${Styles["promo__button"]}`}>{codeIsVisible ? <span className={Styles["promo-code"]}>WEBTEENS10</span> : <p>Получить код</p>}</button>
            </div>
